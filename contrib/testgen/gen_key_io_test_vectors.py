...
bech32_templates = [
  ...
  ('tsla',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('tsla',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('tsla',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttsla',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttsla',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttsla',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtsla',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtsla',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtsla', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttsla',  17, 32, False, False, False),
  ('rtsla',  3,  1, False, False, False),
  ('tsla',   15, 41, False, False, False),
  ('ttsla',  0, 16, False, False, False),
  ('rtsla',  0, 32, True,  False, False),
  ('tsla',   0, 16, True,  False, False),
  ('ttsla',  0, 32, False, True,  False),
  ('rtsla',  0, 20, False, False, True)
]
