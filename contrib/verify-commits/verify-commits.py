#!/usr/bin/env python3
# Copyright (c) 2018 The Muskcoin Core developers
...
def main():
    ...
    while True:
        ...
        os.environ['MUSKCOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
        os.environ['MUSKCOIN_VERIFY_COMMITS_ALLOW_REVSIG'] = "1" if current_commit in revsig_allowed else "0"
