...
"""Verify that starting muskcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start muskcoin with -h for help text")
        ...
        self.log.info("Start muskcoin with -version for version information")
        ...
        self.log.info("Start muskcoind with -fakearg to make sure it does not start")
