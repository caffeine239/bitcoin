...
#ifndef MUSKCOIN_INTERFACES_NODE_H
#define MUSKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a muskcoin node (muskcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MUSKCOIN_INTERFACES_NODE_H
