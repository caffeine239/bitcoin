...
#ifndef MUSKCOIN_QT_MUSKCOINUNITS_H
#define MUSKCOIN_QT_MUSKCOINUNITS_H
...
/** Muskcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MuskcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MuskcoinUnits(QObject *parent);

    /** Muskcoin units.
      @note Source: https://en.muskcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TSLA,
...
typedef MuskcoinUnits::Unit MuskcoinUnit;

#endif // MUSKCOIN_QT_MUSKCOINUNITS_H
