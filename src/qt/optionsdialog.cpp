    ...
    mapper(0)
{
    ...
    ui->muskcoinAtStartup->setToolTip(ui->muskcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->muskcoinAtStartup->setText(ui->muskcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMuskcoinConfButton->setToolTip(ui->openMuskcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MuskcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->muskcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMuskcoinConfButton_clicked()
{
