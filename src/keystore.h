...
#ifndef MUSKCOIN_KEYSTORE_H
#define MUSKCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/muskcoin/bips/blob/master/bip-0013.mediawiki
