...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " muskcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  muskcoin-tx [options] <hex-tx> [commands]  Update hex-encoded muskcoin transaction\n" +
            "or:     muskcoin-tx [options] -create [commands]   Create hex-encoded muskcoin transaction\n" +
            "\n";
