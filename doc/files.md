...
* muskcoin.conf: contains configuration settings for muskcoind or muskcoin-qt
* muskcoind.pid: stores the process id of muskcoind while running
...
* debug.log: contains debug information and general logging generated by muskcoind or muskcoin-qt
