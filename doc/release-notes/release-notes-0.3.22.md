Download URL: https://sourceforge.net/projects/muskcoin/files/Muskcoin/muskcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TSLA fee schedule (users still pay 0.01 TSLA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #muskcoin00 - #muskcoin99
