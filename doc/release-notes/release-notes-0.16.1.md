Muskcoin Core version 0.16.1 is now available from:

  <https://muskcoincore.org/bin/muskcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting muskcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure muskcoind processes are cleaned up when tests end (sdaftuar)
