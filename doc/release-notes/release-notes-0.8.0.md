Muskcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/muskcoin/files/Muskcoin/muskcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Muskcoin
...
New/changed settings (command-line or muskcoin.conf file)
--------------------------------------------------------
