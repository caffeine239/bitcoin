Muskcoin Core version 0.9.4 is now available from:

  https://muskcoin.org/bin/0.9.4/
...
this update is incompatible with the Muskcoin system and could lead to consensus
forks.

Muskcoin Core released binaries from https://muskcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~muskcoin/+archive/ubuntu/muskcoin
- A third-party or self-compiled Muskcoin Core

upgrade to Muskcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
