Muskcoin Core version 0.10.4 is now available from:

  <https://muskcoin.org/bin/muskcoin-core-0.10.4/>
...
- #6953 `43c2789` Split muskcoin-tx into its own package
- #6953 `dfe0d4d` Include muskcoin-tx binary on Debian/Ubuntu
