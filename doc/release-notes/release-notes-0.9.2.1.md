Muskcoin Core version 0.9.2.1 is now available from:

  https://muskcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TSLA to 0.01 TSLA
...
- Fix "Start muskcoin on system login"
