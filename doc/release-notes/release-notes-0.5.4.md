Muskcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/muskcoin/files/Muskcoin/muskcoin-0.5.4/
...
http://gitorious.org/muskcoin/muskcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Muskcoin-Qt notifications under Growl 1.3.
Increase required age of Muskcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMuskcoin properly when installing Muskcoin-Qt over it. (Windows)
