Muskcoin Core version 0.13.2 is now available from:
  ...
  <https://muskcoin.org/bin/muskcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update muskcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow muskcoin-tx to create v2 transactions (tsladrak)
