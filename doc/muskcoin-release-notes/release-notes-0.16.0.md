Muskcoin Core version 0.16.0 is now available from:
  ...
  <https://download.muskcoin.org/muskcoin-0.16.0/>
...
### BIP173 (Bech32) Address support ("tsla1..." addresses)
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("tsla1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 19443 to avoid conflict with testnet's default of 12331.
...
- #482 `5c8e26d` Muskcoin: Basic changes for v0.16 release (thrasher-)
