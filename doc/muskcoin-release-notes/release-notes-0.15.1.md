Muskcoin Core version *0.15.1* is now available from:
  ...
  <https://download.muskcoin.org/muskcoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 TSLA). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 TSLA) in the next release.
